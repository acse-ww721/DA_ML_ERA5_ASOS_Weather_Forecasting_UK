def stn(input_shape=(32, 64, 1), sampling_size=(8, 16), num_classes=10):
    ...
    up6 = keras.layers.Concatenate(axis=-1)(
        [Convolution2D(32, 2, 2, activation='relu', border_mode='same')(UpSampling2D(size=(2, 2))(x)), conv2])
    ...
    up7 = keras.layers.Concatenate(axis=-1)(
        [Convolution2D(32, 2, 2, activation='relu', border_mode='same')(UpSampling2D(size=(2, 2))(conv6)), conv1])
